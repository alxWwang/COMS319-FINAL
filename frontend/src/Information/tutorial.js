        ...
        <main>
          <section>
            ...
            <div style={styles.container}>
              <img src="pictures/tutorials/tut0.png" alt="Main Interface" style={styles.imageFull} />
            ...
            <div style={styles.container}>
              <img src="pictures/tutorials/tut1.png" alt="Search Results" style={styles.imageFull} />
              <p style={styles.tutorialText}>
            ...
            <div style={{...styles.container, ...styles.tutorialSection}}>
              <img src="pictures/tutorials/tut2.png" alt="Route Selection" style={styles.imageHalf} />
              <p style={styles.tutorialText}>
            ...
            <div style={styles.container}>
              <img src="pictures/tutorials/tut3.png" alt="Travel Precedence" style={styles.imageFull} />
              <p style={styles.tutorialText}>
            ...
            <div style={{...styles.container, ...styles.tutorialSection}}>
              <img src="pictures/tutorials/tut4.png" alt="Location Identification" style={styles.imageHalf} />
              <p style={styles.tutorialText}>
